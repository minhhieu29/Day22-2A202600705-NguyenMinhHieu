...
PROMPT_V1_NAME = "nguyen-minh-hieu-rag-prompt-v1"
PROMPT_V2_NAME = "nguyen-minh-hieu-rag-prompt-v2"


# ── 2. Định nghĩa 2 Prompt Templates ──────────────────────────────────────
SYSTEM_V1 = (
    "Bạn là trợ lý AI hữu ích và thân thiện. Chỉ dùng context được cung cấp để trả lời, "
    "giữ câu trả lời ngắn gọn trong 2-4 câu. Nếu context không có thông tin phù hợp, "
    "hãy nói rõ rằng bạn không tìm thấy thông tin này.\n\nContext:\n{context}"
)
...
SYSTEM_V2 = (
    ...
    "rồi trả lời có cấu trúc trong 3-5 câu: nêu ý chính, giải thích ngắn gọn, "
    "và chỉ ra mức độ chắc chắn dựa trên context. Không suy đoán ngoài dữ liệu được cung cấp.\n\n"
    "Context:\n{context}"
)
...
def push_prompts_to_hub(client: Client):
    ...
    try:
        url = client.push_prompt(
            PROMPT_V2_NAME,
            object=PROMPT_V2,
            description="V2 - phong cach chuyen gia, co cau truc",
        )
